...
const translations = {
    en: {
        ...
        blog_beta_title:  'Save The Date: Gofer AI Beta Launching On August 7th, 2026',
        blog_beta_date:   'August 2026',
        ...
        nav_earnings_payouts:'Earnings & Payouts',
        ...
        faq_featured_desc:   'Gofer is an embodied AI and spatial data platform that pays you to record short videos of everyday tasks — things like pouring a glass of water, folding a towel, or stacking plates. Those recordings become high-value training demonstrations that teach next-generation robots how to perform useful, real-world tasks with safe, human-level dexterity. By transforming everyday iPhones into intuitive data collection tools, Gofer bridges the physical data bottleneck in robotics while directly rewarding contributors for their time and data.',

        faq_q_how_works:   'Q: How does it work?',
        faq_a_how_works:   '<p>Getting started as a contributor takes just three simple steps:</p><ol class="faq-steps"><li><strong>Open the app</strong> and pick a task from the available list.</li><li><strong>Follow the on-screen prompt</strong> and record a short video clip (usually under a couple of minutes).</li><li><strong>Submit it.</strong> Once it\'s accepted and verified by our system, you get paid.</li></ol>',
        faq_q_get_started: 'Q: What do I need to get started?',
        faq_a_get_started: 'A: Just your phone. No special equipment. You\'ll set up a free account and complete a quick one-time verification before your first submission.',
        faq_q_phones:      'Q: What phones are supported?',
        faq_a_phones:      'A: Gofer is available on iPhone. Recording uses your phone\'s camera and motion sensors, so it runs on a real device (not an emulator).',
        ...
        faq_q_earnings: 'Q: How much can I earn, and how do I get paid?',
        faq_a_earnings: 'A: Each task shows its pay before you record, so you always know what a clip is worth. Payouts are handled securely through Stripe — you connect a bank account once and manage your balance and transfers from there.',

        faq_q_ownership: 'Q: Who owns my recordings?',
        faq_a_ownership: 'A: You do. When you submit a clip, you choose which kinds of uses it can be licensed for. You stay in control of your own data.',
        ...
        faq_a_privacy:   'A: Yes. You decide what to record and which uses you allow, and we handle your data with care. Full details are in our <a href="https://goferai.space/privacy-policy" style="color: var(--brand-blue);">Privacy Policy</a> and <a href="https://goferai.space/contributor-terms" style="color: var(--brand-blue);">Contributor Terms</a>, linked from the app and this site.',

        faq_q_help: 'Q: How do I get help or ask a question?',
        faq_a_help: 'A: Reach out through the <a href="https://goferai.space/contact" style="color: var(--brand-blue);">contact link on goferai.space</a> and we\'ll get back to you.',
    ...
    es: {
        ...
        blog_beta_title:    'Reserva la Fecha: Lanzamiento Beta de Gofer AI el 7 de Agosto de 2026',
        blog_beta_date:     'Agosto 2026',
        ...
        nav_earnings_payouts:'Ganancias y Pagos',
        ...
        faq_featured_desc:   'Gofer es una plataforma de IA incorporada y datos espaciales que te paga por grabar videos cortos de tareas cotidianas, como servir un vaso de agua, doblar una toalla o apilar platos. Esas grabaciones se convierten en demostraciones de entrenamiento de alto valor que enseñan a los robots de próxima generación a realizar tareas útiles y reales con destreza a nivel humano. Al transformar los iPhones en herramientas intuitivas de recopilación de datos, Gofer resuelve el cuello de botella físico de datos en robótica mientras recompensa directamente a los contribuyentes por su tiempo y datos.',

        faq_q_how_works:   'P: ¿Cómo funciona?',
        faq_a_how_works:   '<p>Empezar como colaborador requiere solo tres pasos sencillos:</p><ol class="faq-steps"><li><strong>Abre la aplicación</strong> y elige una tarea de la lista disponible.</li><li><strong>Sigue la instrucción en pantalla</strong> y graba un video corto (generalmente menos de un par de minutos).</li><li><strong>Envíalo.</strong> Una vez aceptado y verificado por nuestro sistema, recibes tu pago.</li></ol>',
        faq_q_get_started: 'P: ¿Qué necesito para empezar?',
        faq_a_get_started: 'R: Solo tu teléfono. Sin equipo especial. Crearás una cuenta gratuita y completarás una verificación rápida única antes de tu primer envío.',
        faq_q_phones:      'P: ¿Qué teléfonos son compatibles?',
        faq_a_phones:      'R: Gofer está disponible en iPhone. La grabación utiliza la cámara y los sensores de movimiento de tu teléfono, por lo que se ejecuta en un dispositivo real (no en un emulador).',
        ...
        faq_q_earnings: 'P: ¿Cuánto puedo ganar y cómo me pagan?',
        faq_a_earnings: 'R: Cada tarea muestra su pago antes de grabar, para que siempre sepas cuánto vale un clip. Los pagos se procesan de forma segura a través de Stripe: conectas una cuenta bancaria una sola vez y gestionas tu saldo y transferencias desde allí.',

        faq_q_ownership: 'P: ¿Quién es el dueño de mis grabaciones?',
        faq_a_ownership: 'R: Tú. Cuando envías un clip, eliges para qué tipos de usos se puede licenciar. Tú mantienes el control total de tus propios datos.',
        ...
        faq_a_privacy:   'R: Sí. Tú decides qué grabar y qué usos permites, y tratamos tus datos con cuidado. Todos los detalles están en nuestra <a href="https://goferai.space/privacy-policy" style="color: var(--brand-blue);">Política de Privacidad</a> y <a href="https://goferai.space/contributor-terms" style="color: var(--brand-blue);">Términos del Contribuyente</a>.',

        faq_q_help: 'P: ¿Cómo obtengo ayuda o hago una pregunta?',
        faq_a_help: 'R: Contáctanos a través del <a href="https://goferai.space/contact" style="color: var(--brand-blue);">enlace de contacto en goferai.space</a> y te responderemos.',
...
function setLanguage(lang) {
    ...
    if (flagEl) {
        flagEl.src = lang === 'en' ? 'enflag.png' : 'esflag.svg';
